...
export const handleChangeVoyageActivityAuxEngnInput3 = (name, value) => (
  dispatch
) => {
  const formData = {
    name: name,
  ...
  dispatch({
    type: Types.CHANGE_VOYAGE_ACTIVITY_AUX_ENGN_INPUT3,
    payload: formData,
  });
};
...
export const AuxEngnSubmitAction = (
  ...
  auxEngine3Input.dteCreatedAt = voyageInput.fromDate;
