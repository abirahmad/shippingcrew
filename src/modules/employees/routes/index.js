...
import EmployeeApplicationContainer from "../views/employee/EmployeeApplicationContainer";
import EmployeeCrReportListContainer from "../views/employee/EmployeeCrReportListContainer";
...
const routesCCO = [
  ...
  {
    path: "/employee/cr-report-list",
    name: "Hr",
    component: EmployeeCrReportListContainer,
    exact: true,
  },
  ...
  {
    path: "/employee/employee-application",
    name: "Application",
    component: EmployeeApplicationContainer,
    exact: true,
  },
];
