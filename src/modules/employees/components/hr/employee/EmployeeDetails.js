          ...
          <div className="card card-custom gutter-b pt-4">
              ...
              <div className="border-around">
                ...
                <div className="cv-img-div">
                  <div className="myLogo pt-2">
                    ...
                    <Image
                      src={
                        `http://iapps.akij.net/asll/public/assets/images/asllEmployee/` +
                        employeeInfoDetails.image
                      }
                      className="cv-img"
                    />
                  </div>
            ...
            <div className="card-header">
              <div className="card-title text-center">
                <h3 className="card-label text-center">CURRICULUM VITAE</h3>
              </div>
            </div>
            ...
            <Table striped bordered hover>
              <table className="table table-bordered">
                ...
                <tr>
                  ...
                  <td>Ship</td>
                  <td>
                    {employeeInfoDetails.vessel
                      ? employeeInfoDetails.vessel.strVesselName
                      : "No ship found"}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <span className="available">
                      {" "}
                      {employeeInfoDetails.strAvailabilityDate != null
                        ? employeeInfoDetails.strAvailabilityDate
                        : "No date found"}{" "}
                    </span>
                  </td>
                  <td>Salary</td>
                ...
                <tr>
                  ...
                  <td>
                    {employeeInfoDetails.strHeight}/
                    {employeeInfoDetails.strWeight}Kg
                  </td>
                </tr>
                <tr>
                  <td class="font-weight-bold">Remark</td>
                  <td>{employeeInfoDetails.strRemarks}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colSpan="3">
                    {employeeInfoDetails.strBirthdate} &{" "}
                    {employeeInfoDetails.strBirthPlace}
                  </td>
                </tr>
                <tr>
                  <td class="font-weight-bold">Present Address</td>
                  <td colSpan="2" class="font-weight-bold">
                    {employeeInfoDetails.strPresentAddress}
                  </td>
                ...
                <tr>
                  ...
                  <td colSpan="2" class="font-weight-bold">
                    {employeeInfoDetails.strPermanentAddress}
                  </td>
                </tr>
              </table>
            </Table>
            ...
            <Table striped bordered hover>
              <table className="table">
                <tr>
                  <th colSpan="1" className="light-grey font-weight-bold">
                    EDUCATION
                  </th>
                </tr>
                <tr>
                ...
                {employeeInfoDetails.educations.length > 0 &&
                  employeeInfoDetails.educations.map((item, index) => (
                    <tr>
            ...
            <Table striped bordered hover>
              <table className="table light-yellow">
                <thead>
                  <tr>
                    <th colSpan="11">
                      SEA SERVICE RECORD FROM IMMEDIATE LAST SHIP{" "}
                    </th>
                  </tr>
                  ...
                  <tr>
                    <th>{employeeInfoDetails.strRank}</th>
                    {/* <th></th> */}
                    <th>
                      {employeeInfoDetails.vessel
                        ? employeeInfoDetails.vessel.strVesselName
                    ...
                    <th>
                      {employeeInfoDetails.vessel
                        ? employeeInfoDetails.vessel.strVesselFlag
                        : "Flag"}
                    </th>
                    <th>
                      {employeeInfoDetails.vessel
                        ? employeeInfoDetails.vessel.strVesselTypeName
                        : "Type"}
                    </th>
                    <th>
                      {employeeInfoDetails.vessel
                        ? employeeInfoDetails.vessel.numDeadWeight
                        : "DWT"}
                    </th>
                    <th>
                      {employeeInfoDetails.vessel
                        ? employeeInfoDetails.vessel.strEngineName
                        : "Engine"}
                    </th>
                    <th>DD.MM.YY</th>
                    <th>DD.MM.YY</th>
                ...
                {employeeInfoDetails.records.length > 0 &&
                  employeeInfoDetails.records.map((item, index) => (
                    <tr>
                      <td>{employeeInfoDetails.strRank}</td>
            ...
            <Table striped bordered hover>
              <table className="table">
                ...
                {employeeInfoDetails.documents.length > 0 &&
                  employeeInfoDetails.documents.map((item, index) => (
                    <tr>
                      <td>{item.strType}</td>
            ...
            <Table striped bordered hover>
              <table className="table">
                ...
                {employeeInfoDetails.certificates.length > 0 &&
                  employeeInfoDetails.certificates.map((item, index) => (
                    <tr>
            ...
            <Table striped bordered hover>
              <table className="table">
                ...
                <tr>
                  <td>
                    Nationality of Officers & Crew sailed <br />
                    with:
                  </td>
                  <td> {employeeInfoDetails.strNationality}</td>
                </tr>
            ...
            <Table striped bordered hover>
              <table className="table">
                ...
                {employeeInfoDetails.bankdetails.length > 0 &&
                  employeeInfoDetails.bankdetails.map((item, index) => (
                    <tr>
            ...
            <Table striped bordered hover>
              <table className="table">
                <thead className="light-grey">
                  <tr>
                    <th colSpan="1">SAFETY GEAR AND UNIFORM SIZE</th>
                  </tr>
                </thead>
                <tr>
                  <th>Boiler Suit</th>
            ...
            <Table striped bordered hover>
              <table className="table">
                <thead className="light-grey">
                  <tr>
                    <th colSpan="1">IMMIGRATION INFORMATION</th>
                  </tr>
                </thead>
                ...
                <tr>
                  <td>
                    Have you been the subject of a court of enquiry or involved
            ...
            <Table striped bordered hover>
              <table className="table">
                ...
                {employeeInfoDetails.references.length > 0 &&
                  employeeInfoDetails.references.map((item, index) => (
                    <tr>
                ...
                <tr className="light-grey">
                  <td colSpan="3">
                    ...
                    I hereby confirm that all the documents listed above are
                    genuine and in case I am not able to produce the Original
                    listed <br />
                    documents I will be liable for the expenses and
                    consequences.
                  </td>
                </tr>
              </table>
